...
const queenamdiUploader = require("queenjuliet-img");
const fs = require('fs');
...
Juliet.operate({pattern: 'kickme', fromMe: true, desc: Lang.KICKME_DESC, onlyGroup: true, dontAddCommandList: true,  deleteCommand: false}, (async (message, match) => {
...
Juliet.operate({pattern: 'pp', fromMe: true, desc: Lang.PP_DESC, dontAddCommandList: true,  deleteCommand: false}, (async (message, match) => {    
...
Juliet.operate({pattern: 'block ?(.*)', fromMe: true, desc: Lang.BLOCK_DESC, dontAddCommandList: true,  deleteCommand: false}, (async (message, match) => {   
...
Juliet.operate({pattern: 'unblock ?(.*)', fromMe: true, desc: Lang.UNBLOCK_DESC, dontAddCommandList: true,  deleteCommand: false}, (async (message, match) => {    
    if (message.reply_message !== false) {
    ...
    Juliet.operate({pattern: 'jid ?(.*)', fromMe: true, desc: Lang.JID_DESC,  deleteCommand: false}, (async (message, match) => {    
        if (message.reply_message !== false) {
...
Juliet.operate({pattern: 'setalive', fromMe: true, desc: Lang.ALIVE_DESC, dontAddCommandList: true,  deleteCommand: false}, (async (message, match) => {    
    if (message.reply_message === false || message.reply_message.image === false) return await message.client.sendMessage(message.jid,Lang.NEED_PHOTO);
...
Juliet.operate({pattern: 'setwelcome', fromMe: true, desc: Lang.WEL_DESC, dontAddCommandList: true,  deleteCommand: false}, (async (message, match) => {    
    if (message.reply_message === false || message.reply_message.image === false) return await message.client.sendMessage(message.jid,Lang.NEED_PHOTO);
...
Juliet.operate({pattern: 'setbye', fromMe: true, desc: Lang.BYE_DESC, dontAddCommandList: true,  deleteCommand: false}, (async (message, match) => {    
    if (message.reply_message === false || message.reply_message.image === false) return await message.client.sendMessage(message.jid,Lang.NEED_PHOTO);
