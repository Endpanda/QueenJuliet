...
const { MessageType, Mimetype } = require('@endpanda/queenJuliet-web-api');
const fs = require('fs');
...
Juliet.operate({ pattern: 'info', fromMe: LOL, desc: Lang.INFO_DESC, deleteCommand: false}, async (message, match) => { 
...
Juliet.operate({ pattern: 'qawelinfo', fromMe: false, deleteCommand: false, dontAddCommandList: true}, async (message, match) => { 
...
Juliet.operate({pattern: 'covid ?(.*)', fromMe: LOL, desc: LANG.COVID_DESC,  deleteCommand: false}, async (message, match) => {
