...
Juliet.operate({pattern: 'welcome$', fromMe: true,  deleteCommand: false, desc: Lang.WELCOME_DESC, dontAddCommandList: true}, (async (message, match) => {
...
Juliet.operate({pattern: 'welcome (.*)', fromMe: true,  deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
    if (match[1] === '') {
...
Juliet.operate({pattern: 'goodbye$', fromMe: true,  deleteCommand: false, desc: Lang.GOODBYE_DESC, dontAddCommandList: true}, (async (message, match) => {
...
Juliet.operate({pattern: 'goodbye (.*)', fromMe: true,  deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
    if (match[1] === '') {
